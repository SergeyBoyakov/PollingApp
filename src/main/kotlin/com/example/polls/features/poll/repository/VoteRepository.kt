...
interface VoteRepository : JpaRepository<Vote, Long> {
    ...
    fun countByPollIdGroupOrderByChoiceId(@Param(value = "pollId") pollId: Long): List<ChoiceVoteCount>
    ...
    fun findByVotedPollIdsByUserId(@Param("userId") userId: Long, pageable: Pageable): Page<Long>
}